...
#define CY_CFG_SYSCLK_SYSTICK_ENABLED 1
...
__STATIC_INLINE void Cy_SysClk_SysTickInit()
{
    Cy_SysTick_Init(CY_SYSTICK_CLOCK_SOURCE_CLK_CPU, 4799UL);
}
...
{
    (void)Cy_SysClk_ClkPumpSetSource(CY_SYSCLK_PUMP_IN_IMO);
}
