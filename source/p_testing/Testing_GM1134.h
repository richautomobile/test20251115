...
#ifndef _TESTING_GM1134_H_
#define _TESTING_GM1134_H_
...
#if (TESTING_ENABLE==1U) && (PROJECT == GM_VCS_1134)
/* ==[ Macros ]============================================================= */
/**PROJECT DEFINE**/
...
extern t_FUNC_RETURN Testing_Init(void);
extern t_FUNC_RETURN Testing_RoutineCall(void);
